...
Open `mcp-servers-for-revit.sln` in Visual Studio. The solution contains both the plugin and command set projects. Build configurations target Revit 2025 and 2026:

- **Revit 2025-2026**: .NET 8 (`Debug R25` / `Release R25`, `Debug R26` / `Release R26`)
...
- Builds the Revit plugin + command set for Revit 2025 and 2026
